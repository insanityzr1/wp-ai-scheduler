(function ($) {
	...
	$(document).on('change', '#aips-post-feedback-bulk-action', function () {
		var reaction = $(this).val();
		$('#aips-post-feedback-bulk-reason').html(reaction === 'liked' || reaction === 'disliked' ? reasons(reaction) : reasons(''));
		$('.aips-post-feedback-bulk-details').prop('hidden', reaction !== 'liked' && reaction !== 'disliked');
	});
