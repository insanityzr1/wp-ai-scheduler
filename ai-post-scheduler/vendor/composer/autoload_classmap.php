...
return array(
    ...
    'AIPS_Author_Generation_Result_Presenter' => $baseDir . '/includes/class-aips-author-generation-result-presenter.php',
    'AIPS_Author_Generation_Status_Repository' => $baseDir . '/includes/class-aips-author-generation-status-repository.php',
    'AIPS_Author_Post_Generation_Result' => $baseDir . '/includes/class-aips-author-post-generation-result.php',
    ...
    'AIPS_Author_Topic_Batch_Controller' => $baseDir . '/includes/class-aips-author-topic-batch-controller.php',
    'AIPS_Author_Topic_Batch_Items_Repository' => $baseDir . '/includes/class-aips-author-topic-batch-items-repository.php',
    'AIPS_Author_Topic_Batch_Service' => $baseDir . '/includes/class-aips-author-topic-batch-service.php',
    'AIPS_Author_Topic_Candidate_Validator' => $baseDir . '/includes/class-aips-author-topic-candidate-validator.php',
    'AIPS_Author_Topic_Generation_Result' => $baseDir . '/includes/class-aips-author-topic-generation-result.php',
    ...
    'AIPS_Fake_Generation_State' => $baseDir . '/tests/Test_AIPS_Generation_Retry_Scheduler.php',
    'AIPS_Fake_Job_Scheduler' => $baseDir . '/tests/Test_AIPS_Generation_Retry_Scheduler.php',
    ...
    'AIPS_Generation_Claims_Repository' => $baseDir . '/includes/class-aips-generation-claims-repository.php',
    ...
    'AIPS_Generation_Outcome' => $baseDir . '/includes/class-aips-generation-outcome.php',
    'AIPS_Generation_Result' => $baseDir . '/includes/class-aips-generation-result.php',
    'AIPS_Generation_Result_Interface' => $baseDir . '/includes/interface-aips-generation-result-interface.php',
    'AIPS_Generation_Retry_Scheduler' => $baseDir . '/includes/class-aips-generation-retry-scheduler.php',
    'AIPS_Generation_Session' => $baseDir . '/includes/class-aips-generation-session.php',
    'AIPS_Generation_State_Repository' => $baseDir . '/includes/class-aips-generation-state-repository.php',
    ...
    'AIPS_Unit_Ajax_Response_Exception' => $baseDir . '/tests/Test_AIPS_Author_Topic_Batch_Controller_Unit.php',
    ...
    'Test_AIPS_Author_Generation_Result_Presenter_Unit' => $baseDir . '/tests/Test_AIPS_Author_Generation_Result_Presenter_Unit.php',
    'Test_AIPS_Author_Generation_Status_Unit' => $baseDir . '/tests/Test_AIPS_Author_Generation_Status_Unit.php',
    'Test_AIPS_Author_Post_Generator_Batching' => $baseDir . '/tests/Test_AIPS_Author_Post_Generator_Batching.php',
    'Test_AIPS_Author_Post_Generator_Claims' => $baseDir . '/tests/Test_AIPS_Author_Post_Generator_Claims.php',
    'Test_AIPS_Author_Post_Generator_Expansion' => $baseDir . '/tests/Test_AIPS_Author_Post_Generator_Expansion.php',
    'Test_AIPS_Author_Post_Generator_Unit' => $baseDir . '/tests/Test_AIPS_Author_Post_Generator_Unit.php',
    'Test_AIPS_Author_Topic_Batch_Controller_Unit' => $baseDir . '/tests/Test_AIPS_Author_Topic_Batch_Controller_Unit.php',
    'Test_AIPS_Author_Topic_Batch_Recovery_Unit' => $baseDir . '/tests/Test_AIPS_Author_Topic_Batch_Recovery_Unit.php',
    'Test_AIPS_Author_Topic_Batch_Schema_Unit' => $baseDir . '/tests/Test_AIPS_Author_Topic_Batch_Schema_Unit.php',
    'Test_AIPS_Author_Topic_Batch_Service_Unit' => $baseDir . '/tests/Test_AIPS_Author_Topic_Batch_Service_Unit.php',
    'Test_AIPS_Author_Topic_Candidate_Validator_Unit' => $baseDir . '/tests/Test_AIPS_Author_Topic_Candidate_Validator_Unit.php',
    'Test_AIPS_Author_Topic_Notification_Unit' => $baseDir . '/tests/Test_AIPS_Author_Topic_Notification_Unit.php',
    'Test_AIPS_Author_Topic_Refill_Unit' => $baseDir . '/tests/Test_AIPS_Author_Topic_Refill_Unit.php',
    'Test_AIPS_Author_Topics_Repository_Phase1' => $baseDir . '/tests/Test_AIPS_Author_Topics_Repository_Phase1.php',
    ...
    'Test_AIPS_Generation_Claims_Repository' => $baseDir . '/tests/Test_AIPS_Generation_Claims_Repository.php',
    'Test_AIPS_Generation_Context' => $baseDir . '/tests/Test_AIPS_Generation_Context.php',
    'Test_AIPS_Generation_Outcome' => $baseDir . '/tests/Test_AIPS_Generation_Outcome.php',
    'Test_AIPS_Generation_Result' => $baseDir . '/tests/Test_AIPS_Generation_Result.php',
    'Test_AIPS_Generation_Result_Objects' => $baseDir . '/tests/Test_AIPS_Generation_Result_Objects.php',
    'Test_AIPS_Generation_Retry_Scheduler' => $baseDir . '/tests/Test_AIPS_Generation_Retry_Scheduler.php',
    'Test_AIPS_Generation_State_Repository' => $baseDir . '/tests/Test_AIPS_Generation_State_Repository.php',
    ...
    'WP_Error' => $baseDir . '/tests/bootstrap-unit.php',
    'WP_UnitTestCase' => $baseDir . '/tests/bootstrap-unit.php',
);
