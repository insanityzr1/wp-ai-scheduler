...
class AIPS_Admin_Assets {
    ...
    private function enqueue_authors_assets($hook) {
          ...
          wp_localize_script('aips-authors-script', 'aipsAuthorsL10n', array(
			...
			'generateTopicsModalTitle' => __('Generate Topics', 'ai-post-scheduler'),
			'resetScheduleLabel' => __('Reset the next scheduled run from now', 'ai-post-scheduler'),
			'scheduleReset' => __('The recurring schedule was reset.', 'ai-post-scheduler'),
			'schedulePreserved' => __('The recurring schedule was preserved.', 'ai-post-scheduler'),
			'topicQualitySummary' => __('Accepted: %1$d; invalid: %2$d; duplicates: %3$d; still missing: %4$d.', 'ai-post-scheduler'),
			'generationIssues' => __('%1$d failed and %2$d skipped.', 'ai-post-scheduler'),
			'refillAttempts' => __('Refill attempts: %d.', 'ai-post-scheduler'),
			'reviewTopics' => __('Review pending topics', 'ai-post-scheduler'),
			'retryFailedItems' => __('Retry failed items', 'ai-post-scheduler'),
			'retryResults' => __('Retry complete: %1$d succeeded, %2$d failed.', 'ai-post-scheduler'),
			'unknownTopic' => __('Unknown topic', 'ai-post-scheduler'),
			...
			'postSingular' => __('Post', 'ai-post-scheduler'),
			'postPlural' => __('Posts', 'ai-post-scheduler'),
